<script lang="ts">
  ...
  async function handleEncrypt() {
    ...
    if (result.success && result.data) {
      ...
      errorMessage = '';
      encryptSuccess = true;
      setTimeout(() => encryptSuccess = false, 2500);
    } else {
  ...
  function handleKeydown(e: KeyboardEvent) {
    ...
    // ? to toggle shortcuts (only when not in textarea)
...
<svelte:head>
  <title>Encrypt Message - PGP Converter</title>
  <meta name="description" content="Encrypt your messages securely using PGP encryption. Paste your message and public key to generate an encrypted message. All processing happens in your browser." />
  <meta property="og:title" content="Encrypt Message - PGP Converter" />
  <meta property="og:description" content="Encrypt your messages securely using PGP encryption. All processing happens in your browser - no data is sent to any server." />
  ...
  <main class="main">
    ...
    <header class="header">
      ...
      <div class="header-text">
        <h1>PGP Converter</h1>
        <span class="page-title">Encrypt</span>
      </div>
    </header>
